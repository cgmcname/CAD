...
vector<int> parse(string postfix)
{
    ...
    string temp; 
                ...
                while(iss >> temp)
                {
                    ...
                    if( temp == "H")
                    {
                        temp = std::to_string(INT_MIN); //token value to denote operator 
                    }
                    
                    if( temp == "V")
                    {
                        temp = std::to_string(INT_MAX);
                    }
